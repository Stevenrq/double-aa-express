 ...
 * @author steve
 */
public class AdministratorFormView extends javax.swing.JFrame {

    /**
     * Creates new form AdministratorFormView
     */
    public AdministratorFormView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Administrator Register Form");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Administrator Register Form", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 24), new java.awt.Color(0, 153, 153))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministratorFormView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministratorFormView().setVisible(true);
            }
        });
    }
