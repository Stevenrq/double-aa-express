...
public class RegisteredAdministratorsTableView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tRegisteredAdministrators.getColumnModel().getColumnCount() > 0) {
            tRegisteredAdministrators.getColumnModel().getColumn(4).setResizable(false);
            tRegisteredAdministrators.getColumnModel().getColumn(6).setResizable(false);
        }
