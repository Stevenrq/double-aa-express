...
public class OrderManager extends User {
    ...
    public OrderManager(Long id, String firstName, String lastName, String phoneNumber, LocalDate birthDate,
    ...
    public void populateAdministratorTable(JTable table) {
        ...
        for (int i = 0; i < orderManagers.size(); i++) {
            ...
            model.setValueAt(orderManager.getBirthDate(), i, 4);
            model.setValueAt(orderManager.getEmail(), i, 5);
        }
