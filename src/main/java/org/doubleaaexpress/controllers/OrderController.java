...
public class OrderController {
    ...
    public OrderController(Buyer buyer, Motorcycle motorcycle,
        ...
        this.signInFormController = signInFormController;
    }
    ...
    public void registerOrder() {
        ...
        if (getRegisteredMotorcyclesTableView().gettRegisteredMotorcycles().getSelectedRow() != -1) {
            ...
            int selectedRow = getRegisteredMotorcyclesTableView().gettRegisteredMotorcycles()
                    .getSelectedRow();
            ...
            String name = getRegisteredMotorcyclesTableView().gettRegisteredMotorcycles().getValueAt(selectedRow, 1)
                    .toString();
            ...
            String model = getRegisteredMotorcyclesTableView().gettRegisteredMotorcycles().getValueAt(selectedRow, 4)
                    .toString();
            ...
            String status = getRegisteredMotorcyclesTableView().gettRegisteredMotorcycles().getValueAt(selectedRow, 7)
                    .toString();

            int quantityToBuy = Integer
                    .parseInt(JOptionPane.showInputDialog("Enter the quantity of motorcycles you want to purchase: "));
